...
describe("ParseTsConfig", () => {
	...
	describe("Alias Path Resolution", () => {
		...
		it("should handle complex alias patterns", () => {
			...
			const parser = new ParseTsConfig(config, "/project");
			const resolved = parser.resolveAliasPath(
				"@external/article/article.module",
			);
	...
	describe("Edge Cases", () => {
		it("should handle tsconfig without paths", () => {
			...
			const parser = new ParseTsConfig(config, "/project");
			// When paths is undefined, resolveAliasPath returns the original path
			// This is safe behavior - no alias resolution occurs
		...
		it("should handle tsconfig without compilerOptions", () => {
			...
			const parser = new ParseTsConfig(config, "/project");
			// When compilerOptions is missing, parser should handle gracefully
			const resolved = parser.resolveAliasPath("@app/services");
			expect(resolved).toBe("@app/services");
