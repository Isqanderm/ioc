...
describe("GraphGenerator", () => {
	...
	describe("scan method", () => {
		...
		it("should create output directory if it doesn't exist", () => {
			...
			vi.mocked(child_process).spawnSync = vi
				.fn()
		...
		it("should handle providers with special characters in token", () => {
			const json = {
				AppModule: {
					...
					exports: [],
					isGlobal: false,
					providers: [{ token: 'API_URL"test', type: "UseValue" }],
					dependencies: [],
				},
			};
		...
		it("should handle multiple modules with complex relationships", () => {
			const json = {
				AppModule: {
					...
					exports: [],
					isGlobal: false,
					providers: [{ token: "AppService", type: "Class" }],
					dependencies: [],
				},
				UserModule: {
					name: "UserModule",
					...
					exports: ["UserService"],
					isGlobal: false,
					providers: [{ token: "UserService", type: "Class" }],
					dependencies: [],
				},
			};
